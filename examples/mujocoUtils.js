...
export async function reloadFunc() {
  ...
  } else if (this.params.scene.includes("go2")) {
    this.camera.position.set(1.5, 1.5, 1.0);
...
export function setupGUI(parentContext) {
  ...
  parentContext.params.scene = parentContext.params.scene || "piano_with_shadow_hands/scene.xml";
